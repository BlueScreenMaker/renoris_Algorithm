package _2022._07_13.programmers;
...
class 리틀프렌즈사천성 {
    ...
    private boolean canOneDraft (int[] indexs, char[][] board) {;
        ...
        //좌우먼저
        boolean horizontalFirst = searchHorizontal(indexs[0], indexs[2], indexs[1], board)
                && board[indexs[1]][indexs[2]] == '.' &&
                searchVertical(indexs[1], indexs[3], indexs[2], board);
